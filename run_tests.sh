...
# Description: Run all tests in sequence with psql
# =====================================================

# Database Connection Info (override via environment)
...
run_test() {
    ...
    psql -v ON_ERROR_STOP=1 < "$file" > /tmp/test_out.log 2>&1
...
if ! psql -c "SELECT 1" > /dev/null 2>&1; then
    ...
    echo "  Set PGHOST, PGPORT, PGUSER, PGDATABASE, PGPASSWORD as needed"
    exit 1
fi

echo "Running tests against: $PGHOST:$PGPORT/$PGDATABASE"
echo ""
...
if run_test "tests/00_bootstrap_validation.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/01_function_code_frame_schema.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/02_method_object_schema.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/03_builtin_functions_integration.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/04_ceval_stack_operations.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/05_ceval_opcode_utils.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/06_ceval_integration.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/07_ceval_eval_frame.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/08_ceval_opcodes_basic.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/09_ceval_integration_advanced.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/10_ceval_opcode_store_name.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/11_ceval_integration_store_name.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/12_ceval_opcode_load_name.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/13_ceval_integration_load_name.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/14_ceval_opcode_call_function.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/15_ceval_integration_call_function.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/16_ceval_integration_abs.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/17_tp_hash_slot.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/18_dict_lookup_hash.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/19_ceval_integration_full_pipeline.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/20_tp_richcompare_slot.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/21_binary_add_slots.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/22_binary_add_integration.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/23_binary_subtract_slots.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/24_binary_subtract_integration.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/25_binary_multiply_slots.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/26_binary_multiply_integration.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/27_compare_op_slots.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/28_compare_op_integration.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/29_py_object_istrue_slots.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/30_jump_integration.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/31_pop_top_integration.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/32_exception_schema.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/33_exception_table_parsing.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/34_try_except_integration.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/35_tp_call_kwargs_reject.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/36_call_function_kw_integration.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/37_meth_keywords_integration.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/38_extended_arg_integration.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/39_float_slots_integration.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/40_bytes_slots_integration.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/41_build_tuple_list_integration.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/42_load_attr_integration.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/43_load_attr_phase2_integration.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/44_store_attr_integration.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/45_bound_method_integration.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/46_integrated_scenarios.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/47_store_attr_class_integration.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/48_delete_attr_integration.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/49_binary_op_integration.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/50_ceval_opcode_load_global.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/51_ceval_integration_load_global.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/52_ceval_opcode_load_fast_store_fast.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/53_ceval_integration_load_fast_store_fast.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/54_ceval_opcode_nop_jump_backward_delete_fast.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/55_ceval_opcode_pop_jump_backward.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/56_ceval_opcode_delete_global.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/57_ceval_opcode_copy.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/58_ceval_opcode_pop_jump_backward_if_none.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/59_ceval_opcode_unary_not.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/60_ceval_opcode_is_op.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/61_ceval_opcode_pop_jump_forward_if_none.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/62_ceval_opcode_list_to_tuple.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/63_ceval_opcode_jump_if_false_or_pop.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/64_ceval_opcode_unpack_sequence.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/65_ceval_opcode_contains_op.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/66_ceval_opcode_build_map.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/67_ceval_opcode_binary_subscr.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/68_ceval_opcode_store_subscr.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/69_ceval_opcode_delete_subscr.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/70_ceval_opcode_build_slice.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/71_ceval_opcode_make_function.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/72_ceval_opcode_unary_negative.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/73_ceval_opcode_unary_positive.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/74_ceval_opcode_load_method.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/75_ceval_opcode_get_iter_for_iter.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/76_ceval_opcode_closures.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/77_builtin_print.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/78_builtin_range.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/79_class_construction.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/80_instance_creation.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/81_type_constructors.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/82_common_builtins.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/83_binary_ops_extended.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/84_swap_comprehensions_fstrings.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/85_star_unpacking.sql"; then
    echo ""
else
    echo ""
...
if run_test "tests/86_py_run.sql"; then
    echo ""
else
    echo ""
...
echo "==========================================="
echo ""
echo "Total: 87 test suites passed"
echo ""
echo "Note: Additional tests can be added to the tests/ directory"
echo ""
