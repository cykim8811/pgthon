...
-- Pgthon: no-op; read arg only for bytecode advance.
-- Depends: ceval_core.
-- ============================================================================

-- RESUME (151): CPython 3.11 — frame entry no-op. Pgthon: no-op.
...
BEGIN
    ...
    END IF;
    -- No-op (where_arg 0=start, 1=yield, 2=yield from, 3=await; unused in Pgthon).
END;
$$ LANGUAGE plpgsql;
