-- ============================================================================
-- Migration: Opcode JUMP_IF_FALSE_OR_POP (111) — CPython 3.11
-- 20260114240337
--
-- If TOS is false, jump forward (next = current + 2 + oparg*2), leave TOS.
-- Else pop TOS and fall through.
-- Depends: ceval_core (py_stack_pop, py_stack_push), py_object_istrue.
-- ============================================================================
CREATE OR REPLACE FUNCTION public.py_opcode_JUMP_IF_FALSE_OR_POP(
