...
DECLARE
    ...
    ID_DICT_CODE_TYPE UUID := gen_random_uuid();
...
BEGIN
    ...
    (ID_DICT_CODE_TYPE, NULL),   -- dict for code type
    ...
    WHERE id IN (ID_OBJECT_TYPE, ID_TYPE_TYPE, ID_STR_TYPE, ID_BYTES_TYPE, ID_INT_TYPE, ID_FLOAT_TYPE, ID_LIST_TYPE, ID_DICT_TYPE, ID_TUPLE_TYPE, ID_NONE_TYPE, ID_BUILTIN_FUNCTION_OR_METHOD_TYPE, ID_MODULE_TYPE, ID_BOOL_TYPE, ID_NOT_IMPLEMENTED_TYPE, ID_NULL_TYPE, ID_SLICE_TYPE, ID_FUNCTION_TYPE, ID_SET_TYPE, ID_CODE_TYPE, ID_LIST_ITERATOR_TYPE, ID_TUPLE_ITERATOR_TYPE, ID_DICT_KEYITERATOR_TYPE, ID_STR_ITERATOR_TYPE);
    ...
    WHERE id IN (ID_DICT_OBJECT_TYPE, ID_DICT_TYPE_TYPE, ID_DICT_STR_TYPE, ID_DICT_INT_TYPE,
                 ...
                 ID_DICT_BUILTIN_FUNCTION_OR_METHOD_TYPE, ID_DICT_MODULE_TYPE, ID_DICT_BOOL_TYPE, ID_DICT_NOT_IMPLEMENTED_TYPE, ID_DICT_NULL_TYPE, ID_DICT_SLICE_TYPE, ID_DICT_FUNCTION_TYPE, ID_DICT_SET_TYPE, ID_DICT_CODE_TYPE,
    ...
    (ID_DICT_CODE_TYPE), -- dict for code type
    ...
    WHERE ob_base IN (ID_STR_TYPE, ID_INT_TYPE, ID_FLOAT_TYPE, ID_LIST_TYPE, ID_DICT_TYPE, ID_TUPLE_TYPE, ID_NONE_TYPE, ID_BUILTIN_FUNCTION_OR_METHOD_TYPE, ID_MODULE_TYPE, ID_BOOL_TYPE, ID_NOT_IMPLEMENTED_TYPE, ID_NULL_TYPE, ID_SLICE_TYPE, ID_FUNCTION_TYPE, ID_SET_TYPE, ID_CODE_TYPE, ID_LIST_ITERATOR_TYPE, ID_TUPLE_ITERATOR_TYPE, ID_DICT_KEYITERATOR_TYPE, ID_STR_ITERATOR_TYPE);
    ...
    UPDATE public.py_type_object SET tp_dict = ID_DICT_CODE_TYPE WHERE ob_base = ID_CODE_TYPE;
