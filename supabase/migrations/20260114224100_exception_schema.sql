...
BEGIN
  ...
  WHERE id IN (ID_BASE_EXCEPTION_TYPE, ID_EXCEPTION_TYPE, ID_TYPE_ERROR_TYPE, ID_VALUE_ERROR_TYPE, ID_NAME_ERROR_TYPE, ID_TRACEBACK_TYPE, ID_RUNTIME_ERROR_TYPE, ID_ATTRIBUTE_ERROR_TYPE, ID_INDEX_ERROR_TYPE, ID_KEY_ERROR_TYPE);
  ...
  WHERE id IN (ID_DICT_BASE_EXCEPTION, ID_DICT_EXCEPTION, ID_DICT_TYPE_ERROR, ID_DICT_VALUE_ERROR, ID_DICT_NAME_ERROR, ID_DICT_TRACEBACK, ID_DICT_RUNTIME_ERROR, ID_DICT_ATTRIBUTE_ERROR, ID_DICT_INDEX_ERROR, ID_DICT_KEY_ERROR);
