-- ============================================================================
-- Migration: VM Stack Operations
-- Created: 2026-01-14 23:00:00
--
-- Purpose:
--   Implements the core stack operations for the Elytra VM. These functions
--   manage the evaluation stack (f_valuestack) in frame objects, which is
--   the foundation for all bytecode execution.
--
--   Functions:
...
--
--   These operations mirror CPython's stack manipulation in PyEval_EvalFrameEx,
--   where values are pushed/popped from the frame's value stack during bytecode
--   execution. All opcodes that need to manipulate the stack will use these
--   functions.
--
-- Design:
...
--   - No stack overflow check (PostgreSQL array limits are very high)
-- ============================================================================
