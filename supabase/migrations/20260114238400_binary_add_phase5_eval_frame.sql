-- ============================================================================
-- Migration: BINARY_ADD Phase 5 — py_eval_frame에 opcode 23 분기 (작업 K)
-- Created: 2026-01-14 23:84:00
--
-- Purpose:
--   opcode 23 (BINARY_ADD) 실행 시 public.py_opcode_BINARY_ADD(frame_id) 호출.
--   eval_frame 수정은 별도 마이그레이션에 두는 기존 규칙에 따라 이 파일만 사용.
--
-- Design: docs/BINARY_ADD_IMPLEMENTATION_PLAN.md
-- ============================================================================

-- py_eval_frame 재정의: opcode 23 분기 추가
