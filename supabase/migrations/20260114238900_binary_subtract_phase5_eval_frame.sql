-- ============================================================================
-- Migration: BINARY_SUBTRACT Phase 5 — py_eval_frame에 opcode 24 분기 (작업 K)
-- Created: 2026-01-14 23:89:00
--
-- Purpose:
--   opcode 24 (BINARY_SUBTRACT) 실행 시 public.py_opcode_BINARY_SUBTRACT(frame_id) 호출.
--   기존 opcode 23 (BINARY_ADD) 분기 유지.
--
