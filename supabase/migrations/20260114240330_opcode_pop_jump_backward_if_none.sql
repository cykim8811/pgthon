-- ============================================================================
-- Migration: Opcode POP_JUMP_BACKWARD_IF_NONE (173) — CPython 3.11
-- 20260114240330
--
-- Pops TOS. If TOS is None, jump to target instruction offset (oparg).
-- CPython 3.11: oparg = target instruction offset; byte offset = oparg * 2.
-- Depends: ceval_core (py_stack_pop), py_none_object.
-- ============================================================================
CREATE OR REPLACE FUNCTION public.py_opcode_POP_JUMP_BACKWARD_IF_NONE(
