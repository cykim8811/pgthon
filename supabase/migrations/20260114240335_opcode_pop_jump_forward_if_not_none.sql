-- ============================================================================
-- Migration: Opcode POP_JUMP_FORWARD_IF_NOT_NONE (129) — CPython 3.11
-- 20260114240335
--
-- Pops TOS. If TOS is not None, jump forward: next_byte_offset = current + 2 + oparg*2.
-- CPython 3.11: oparg = delta in instruction words; byte offset += 2 + oparg*2.
-- Depends: ceval_core (py_stack_pop), py_none_object.
-- ============================================================================
CREATE OR REPLACE FUNCTION public.py_opcode_POP_JUMP_FORWARD_IF_NOT_NONE(
