-- ============================================================================
-- LOAD_NAME: Python-level NameError via py_err_set_name_error (5단계)
-- 20260114241200_opcode_load_name_exception.sql
--
-- Design: docs/EXCEPTION_HANDLING_DESIGN.md §2.7
-- 기존 py_opcode_LOAD_NAME의 RAISE EXCEPTION 'NameError: ...' 제거,
-- py_err_set_name_error 호출 후 RETURN. py_eval_frame이 py_err_occurred()로 처리.
-- ============================================================================
