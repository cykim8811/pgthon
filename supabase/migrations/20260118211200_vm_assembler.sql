-- =====================================================
-- Migration: VM Assembler (Deduplication Support)
-- Description: Assemble text bytecode into executable code objects with distinct constant and variable pools
-- =====================================================
    ...
    FOREACH v_line IN ARRAY v_lines LOOP
        ...
        IF length(v_line) > 0 AND substring(v_line from 1 for 1) <> '#' THEN
            ...
            IF array_length(v_parts, 1) > 1 THEN
                ...
                -- LOAD_ATTR, STORE_ATTR: Use varnames pool for simplicity (should use 'names' in full impl)
