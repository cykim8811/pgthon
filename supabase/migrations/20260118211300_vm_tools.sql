-- =====================================================
-- Migration: VM Inspector & REPL Helpers
-- Description: Object inspection and high-level API for REPL
-- =====================================================

-------------------------------------------------------
-- vm_inspect_object: Inspect object and return JSON representation
-------------------------------------------------------
...
-------------------------------------------------------
-- vm_execute_source: High-level API to assemble and run code
-------------------------------------------------------
