...
--   - LOAD_CONST + LOAD_NAME + CALL_FUNCTION: 상수와 함수 조합
...
BEGIN
    ...
    -- ========================================================================
    -- Test 1: LOAD_CONST + LOAD_NAME + CALL_FUNCTION + RETURN_VALUE
    --         (len("hello") 실행)
    -- ========================================================================
    RAISE NOTICE 'Test 1: LOAD_CONST + LOAD_NAME + CALL_FUNCTION + RETURN_VALUE (len("hello"))...';
    ...
    -- Create bytecode: LOAD_CONST(0) LOAD_NAME(0) CALL_FUNCTION(1) RETURN_VALUE
    -- Bytecode: [100, 0, 101, 0, 141, 1, 83, 0]
    -- LOAD_CONST = 100, LOAD_NAME = 101, CALL_FUNCTION = 141, RETURN_VALUE = 83
    co_code_id := gen_random_uuid();
    INSERT INTO public.py_object (id, ob_type) VALUES (co_code_id, ID_BYTES_TYPE);
    INSERT INTO public.py_bytes_object (ob_base, bytes_value) VALUES (co_code_id, E'\\x640065008d015300'::bytea);
    ...
    -- ========================================================================
    -- Test 2: LOAD_CONST + LOAD_NAME + CALL_FUNCTION + RETURN_VALUE
    --         (len("world") 실행)
    -- ========================================================================
    RAISE NOTICE '';
    RAISE NOTICE 'Test 2: LOAD_CONST + LOAD_NAME + CALL_FUNCTION + RETURN_VALUE (len("world"))...';
    test_count := test_count + 1;
    ...
    -- Create bytecode: 
    --   LOAD_CONST(0) LOAD_NAME(0) CALL_FUNCTION(1)  -- len("hello")
    --   LOAD_CONST(1) LOAD_NAME(0) CALL_FUNCTION(1)  -- len("world")
    --   RETURN_VALUE
    -- Bytecode: [100, 0, 101, 0, 141, 1, 100, 1, 101, 0, 141, 1, 83, 0]
    co_code_id := gen_random_uuid();
    INSERT INTO public.py_object (id, ob_type) VALUES (co_code_id, ID_BYTES_TYPE);
    INSERT INTO public.py_bytes_object (ob_base, bytes_value) VALUES (co_code_id, E'\\x640065008d01640165008d015300'::bytea);
