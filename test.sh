...
# 15. Arithmetic Extended (Custom Methods)
echo "=== Phase 15: Arithmetic Extended ==="
run_test "supabase/tests/15_arithmetic_extended.sql"
echo ""

# 16. Error Handling Extended
echo "=== Phase 16: Error Handling Extended ==="
